...
public class Main {
    ...
    static float[] cortarConstructorNomina(String textoConstructor) {
        ...
        parametrosPrincipales[1] = Float.parseFloat(
                textoConstructor.substring(textoConstructor.indexOf("_") + 1, textoConstructor.lastIndexOf("_")));
        parametrosPrincipales[2] = Float.parseFloat(
                textoConstructor.substring(textoConstructor.lastIndexOf("_") + 1, textoConstructor.indexOf("/")));
    ...
    public static void main(String[] args) {
        ...
        nomina = new Nomina(cortarConstructorNomina(textoConstructor)[0], cortarConstructorNomina(textoConstructor)[1],
                cortarConstructorNomina(textoConstructor)[2], (int) (cortarConstructorNomina(textoConstructor)[3]));
        ...
        System.out.println(nomina.seguridadSocial(porcentajesCotizacion(textoConstructor)[1], porcentajesCotizacion(textoConstructor)[2],
        ...
        System.out.printf("El sueldo neto de esta persona es de %.2f",
